...
$cat_id = $_GET["Id"];
if ($cat_id) {
    $q = "select * from product where cat_id='$cat_id'";
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                    ...
                                    <div class="product-tab">
                                        ...
                                        if ($check > 0) {
                                            while ($data_read = mysqli_fetch_array($exe)) {
                                        ?>
                                                <div class="col-md-3 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        <div class="grid-arrival">
                                                            <figure>
                                                                ...
                                                                <a href="single.php?ID=<?php echo $data_read['id']; ?>" class="new-gridx">
                                                                    <div class="grid-img">
                                                                        <img src="upload/<?php echo $data_read['p_img1']; ?>" class="img-responsive" alt="">
                                                                    </div>
                                                                    <div class="grid-img">
                                                                        <img src="upload/<?php echo $data_read['p_img2']; ?>" class="img-responsive" alt="">
                                                                    </div>
                                                                </a>
                                                            </figure>
                                                        </div>
                                                    ...
                                                    <div class="starbox small ghosting"> </div>
                                                        ...
                                                        <div class="grid-info">
                                                            <h6><?php echo $data_read['p_title']; ?></h6>
                                                            <!-- <span class="size">XL / XXL / S </span> -->
                                                            <p><del>&#8377;<?php echo $data_read['mrp']; ?> </del>&nbsp;<em class="item_price">&#8377;<?php echo $data_read['price']; ?></em></p>
                                                            <a href="#" data-text="Add To Cart" class="my-cart-b item_add">View Details</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php }
